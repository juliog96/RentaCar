            ...
            <div style="text-align: center">
                <div style="display: flex;margin-left: 15%;margin-top: 3%;">
                    ...
                    <form action="Eliminaciones" method="POST">
                        <input class="button" type="submit" value="ELIMINAR CIUDAD" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                </div>
                ...
                <div style="display: flex;margin-top: 3%;">
                    ...
                    <form action="Eliminaciones" method="POST" style="margin-right: 5%;">
                        <input class="button" type="submit" value="ELIMINAR COCHE" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                    <form action="Modificaciones" method="POST" style="margin-right: 5%;">
                        <input class="button" type="submit" value="MODIFICAR COCHE" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                </div>
                <hr style="color: #a59e9e;border-top: 2px solid;margin-top: 3%;margin-left: -26%;" />
                <div style="display: flex;margin-left: 7%;margin-top: 3%;">
                    ...
                    <form action="Eliminaciones" method="POST">
                        <input class="button" type="submit" value="ELIMINAR LOCALIZACION" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                </div>
                <hr style="color: #a59e9e;border-top: 2px solid;margin-top: 3%;margin-left: -26%;" />
                <div style="display: flex;margin-top: 3%;">
                    ...
                    <form action="Eliminaciones" method="POST" style="margin-right: 5%;">
                        <input class="button" type="submit" value="ELIMINAR TIENDA" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                    <form action="Modificaciones" method="POST" style="margin-right: 5%;">
                        <input class="button" type="submit" value="MODIFICAR TIENDA" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                    </form>
                </div>
                <hr style="color: #a59e9e;border-top: 2px solid;margin-top: 3%;margin-left: -26%;" />
                <form action="TiendasByCiudad" method="POST" style="margin-top: 3%;">
                    <input class="button" type="submit" value="RANKING TIENDA POR NUM FACTURAS" style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                </form>
                <hr style="color: #a59e9e;border-top: 2px solid;margin-top: 3%;margin-left: -26%;" />
                <form action="TiendasByCiudad" method="POST" style="margin-top: 3%;">
                    <input class="button" type="submit" value="TOP 3 TIENDAS MAYOR FACTURACION " style="cursor: pointer; margin-left: -25%; margin-top: 2%">
                </form>
            </div>
        </div>
        <%
